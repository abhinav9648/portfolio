					...
					<div id="vmarine" className="modal-card">
						...
						<div className="modal-info">
							...
							<div className="modal-description">
								<ul>
									<li>
										it is prototype website for the customer to book movie tickets
										and making the selection of seats and the movies.
									</li>
									<li>
					...
					<div id="agualuz" className="modal-card">
						...
						<div className="modal-info">
							...
							<div className="modal-description">
								<ul>
									<li>
										it is a blog website to publish the blogs
					...
					<div id="todolist" className="modal-card">
						...
						<div className="modal-info">
							...
							<div className="modal-description">
								<ul>
									<li>
										a travelling website for the ultimate nature trips experience.
									</li>
									<li>
										Developed with HTML5, CSS3, Bootstrap,
										Webpack, and ReactJS.
